...
public class Fertilizer extends AppCompatActivity {
    ...
    String[] mOptions1 = {"----चुनते हैं----","गन्ना","कपास","चावल-कश्मीर","चावल-p","सूरजमुखी-वर्षा आधारित","सूरजमुखी-सिंचित"};
    String[] mOptions2 = {"----தேர்வு----","கரும்பு","பருத்தி","அரிசி-கே","அரிசி-ப","சூரியகாந்தி-மானாவாரி","சூரியகாந்தி-பாசனம்"};
    String[] mOptions3 = {"----ఎంచుకోండి----","చెరుకుగడ","కాటన్","రైస్-k","బియ్యపు p","సన్ఫ్లవర్-rainfed","సన్ఫ్లవర్ సాగునీటి"};
    ImageView imageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        /*i=getIntent().getIntExtra("v1",3);*/
        SharedPreferences prefs = PreferenceManager.getDefaultSharedPreferences(this);
        int i = prefs.getInt("n", 0);
        ...
        if(i==1){
            ArrayAdapter a=new ArrayAdapter(Fertilizer.this,android.R.layout.simple_spinner_item,mOptions2);
            a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            mSpinner.setAdapter(a);}
        if(i==2){ArrayAdapter a=new ArrayAdapter(Fertilizer.this,android.R.layout.simple_spinner_item,mOptions1);
            a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            mSpinner.setAdapter(a); }
        if(i==3){
            ArrayAdapter a=new ArrayAdapter(Fertilizer.this,android.R.layout.simple_spinner_item,mOptions3);
            a.setDropDownViewResource(android.R.layout.simple_spinner_dropdown_item);
            mSpinner.setAdapter(a);
